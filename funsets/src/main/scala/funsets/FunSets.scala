...
object FunSets {
  ...
  */
  ...
  /* the negation of 'p  is valid for all element of s' is 'it exists one element of s that satififes !p'*/
  /* applying the correct negation where needed to get 'it exists elem in s that satifisfies p' we get */
